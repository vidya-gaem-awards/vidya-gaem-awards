...
$(document).ready(function () {
    ...
    function openLootboxRewards(force) {
        ...
        $.post('/inventory/purchase-lootbox').then(function (data) {
    ...
    if (votingEnabled) {
        if (topArea.length > 0) {
            ...
            new sortablejs_1["default"](document.getElementById('voteDropAreaBottom'), sortableOptions);
        }
