...
<p>Click on the row headers to sort by platform. List is from <a href="https://en.wikipedia.org/wiki/2013_in_video_gaming">Wikipedia</a> with some additions from the /v/GA team.</p>
</header>
