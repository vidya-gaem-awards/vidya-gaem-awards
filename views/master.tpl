...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/bootstrap-2.1.0/css/bootstrap.min.css">
    <link rel="stylesheet" href="/bootstrap-2.1.0/css/bootstrap-responsive.min.css">
            ...
            <div class="container">
                ...
                <ul class="nav secondary-nav">
                    <if:loggedIn>
                        ...
                        <li><a href="https://steamcommunity.com/profiles/<tag:communityID />"> <tag:displayName /></a></li>
                    <else:loggedIn>
