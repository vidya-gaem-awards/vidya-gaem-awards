...
<div id="dialog-delete" class="modal hide">
  ...
  <div class="modal-footer">
    <span id="dialog-delete-status"><img src='/loading.gif' width="16px"> deleting...&nbsp;</span>
...
<div id="dialog-edit" class="modal hide">
  ...
  <div class="modal-footer">
    <span id="dialog-edit-status" style="display: none;"><img src='/loading.gif' width="16px"> saving...&nbsp;</span>
